...
class MonthAdapter2(var context: ModalBottomSheet, val date:ArrayList<String>):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Month2ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_calendar_month2, parent, false)

        return Month2ViewHolder(view)
    }

    @SuppressLint("SetText| 18n")
    override fun onBindViewHolder(holder: Month2ViewHolder, position: Int) {
        calendar.time = Date()
